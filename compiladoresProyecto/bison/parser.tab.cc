...
#line 144 "parser.tab.cc"
  ...
  calculadora_parser::syntax_error::~syntax_error () YY_NOEXCEPT YY_NOTHROW
  {}
  ...
  // by_state.
  calculadora_parser::by_state::by_state () YY_NOEXCEPT
    : state (empty_state)
  {}

  calculadora_parser::by_state::by_state (const by_state& that) YY_NOEXCEPT
    : state (that.state)
  {}

  void
  calculadora_parser::by_state::clear () YY_NOEXCEPT
  {
    state = empty_state;
  }
  ...
  calculadora_parser::by_state::by_state (state_type s) YY_NOEXCEPT
    : state (s)
  {}

  calculadora_parser::symbol_kind_type
  calculadora_parser::by_state::kind () const YY_NOEXCEPT
  {
  ...
  calculadora_parser::stack_symbol_type::stack_symbol_type (YY_RVREF (stack_symbol_type) that)
  ...
  calculadora_parser::stack_symbol_type::stack_symbol_type (state_type s, YY_MOVE_REF (symbol_type) that)
  ...
  calculadora_parser::stack_symbol_type&
  calculadora_parser::stack_symbol_type::operator= (stack_symbol_type& that)
  {
    state = that.state;
    switch (that.kind ())
    {
  ...
  template <typename Base>
  void
  calculadora_parser::yy_print_ (std::ostream& yyo, const basic_symbol<Base>& yysym) const
  {
...
#line 40 "parser.yy"
                 { yyoutput << yysym.value.template as < float > (); }
#line 357 "parser.tab.cc"
        break;

      case symbol_kind::S_F: // F
#line 40 "parser.yy"
                 { yyoutput << yysym.value.template as < float > (); }
#line 363 "parser.tab.cc"
        break;
  ...
  void
  calculadora_parser::yypush_ (const char* m, YY_MOVE_REF (stack_symbol_type) sym)
  {
    if (m)
  ...
  void
  calculadora_parser::yypush_ (const char* m, state_type s, YY_MOVE_REF (symbol_type) sym)
  {
#if 201103L <= YY_CPLUSPLUS
  ...
  void
  calculadora_parser::yypop_ (int n) YY_NOEXCEPT
  {
    yystack_.pop (n);
  }
  ...
  bool
  calculadora_parser::yy_pact_value_is_default_ (int yyvalue) YY_NOEXCEPT
  {
    return yyvalue == yypact_ninf_;
  }

  bool
  calculadora_parser::yy_table_value_is_error_ (int yyvalue) YY_NOEXCEPT
  {
    return yyvalue == yytable_ninf_;
  }

  int
  calculadora_parser::operator() ()
  {
    return parse ();
  }
  ...
  case 3: // E: E "+" T
#line 46 "parser.yy"
    { yylhs.value.as < float > () = yystack_[2].value.as < float > (); }
...
#line 667 "parser.tab.cc"
  ...
  std::string
  calculadora_parser::symbol_name (symbol_kind_type yysymbol)
  {
  ...
  // calculadora_parser::context.
  calculadora_parser::context::context (const calculadora_parser& yyparser, const symbol_type& yyla)
    : yyparser_ (yyparser)
    , yyla_ (yyla)
  {}

  int
  calculadora_parser::context::expected_tokens (symbol_kind_type yyarg[], int yyargn) const
  {
  ...
  int
  calculadora_parser::yy_syntax_error_arguments_ (const context& yyctx,
  ...
  std::string
  calculadora_parser::yysyntax_error_ (const context& yyctx) const
  {
    // Its maximum.
    enum { YYARGS_MAX = 5 };
...
#undef YYCASE_
  ...
  const signed char calculadora_parser::yypact_ninf_ = -7;
  ...
  void
  calculadora_parser::yy_stack_print_ () const
  {
    *yycdebug_ << "Stack now";
  ...
  void
  calculadora_parser::yy_reduce_print_ (int yyrule) const
  {
